...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Loop-Erkennung: nur Self-Loop (From = To) abfangen.
    // From = Outbound-Nummer darf NICHT als Loop gewertet werden –
    // bei Anrufweiterleitung zeigt Twilio als From die ursprüngliche
    // Outbound-Nummer, obwohl es ein echter Inbound-Weiterleitungsanruf ist.
