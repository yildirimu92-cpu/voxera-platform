...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Damit erscheint der Anruf sofort in der DB — unabhängig davon ob das
    // ElevenLabs-Tool am Ende korrekt aufgerufen wird.
    // elevenlabs-post-call wird später per UPDATE die fehlenden Felder ergänzen.
    const callRecord = {
      call_id: callSid,
