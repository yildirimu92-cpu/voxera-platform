...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Loop: From = eigene Outbound-Nummer (ElevenLabs Post-Call Rückruf)
    // ODER From = To (Self-Loop)
    const isLoopCall = (outboundFromNumber && fromNormalized === outboundFromNumber)
