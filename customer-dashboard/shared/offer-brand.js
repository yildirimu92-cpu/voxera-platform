...
(function loadCustomerRuntimes(root) {
  ...
  [
    ...
    ['__voxeraCustomerCalendarSettingsLoaded', '/shared/customer-runtime-calendar-settings.js?v=20260803-1'],
    ...
    ['__voxeraCustomerDesignFoundationLoaded', '/shared/customer-runtime-design-foundation.js?v=20260803-3']
  ].forEach(([flag, src]) => {
    if (root[flag]) return;
    root[flag] = true;
