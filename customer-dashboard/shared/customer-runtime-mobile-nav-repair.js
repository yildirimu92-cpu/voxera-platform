    ...
    if (!style) {
      ...
      style.textContent = `
        @media (max-width: 768px) {
          ...
          #mnav-dashboard :is(i, svg),
          #mnav-anrufe :is(i, svg),
          #mnav-assistent :is(i, svg),
          #mnav-auswertung :is(i, svg),
          #mnav-mehr :is(i, svg) {
          ...
          #mnav-dashboard:is(.active, .vx-root-nav-active),
          #mnav-anrufe:is(.active, .vx-root-nav-active),
          #mnav-assistent:is(.active, .vx-root-nav-active),
          #mnav-auswertung:is(.active, .vx-root-nav-active),
          #mnav-mehr:is(.active, .vx-root-nav-active) {
