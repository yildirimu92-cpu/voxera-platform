...
assert.match(source.loader, /customer-runtime-calendar-settings\.js\?v=20260803-1/);
...
assert.match(source.loader, /customer-runtime-design-foundation\.js\?v=20260803-3/);
