...
assert.match(source.loader, /customer-runtime-calendar-settings\.js\?v=20260807-2/);
...
assert.match(source.loader, /customer-runtime-design-foundation\.js\?v=20260807-3/);
