...
const checks = [
  ...
  ['Final reminder L2 is normalized', runtime.includes('REMINDER L2|REMINDER_FINAL') && runtime.includes('[REMINDER_FINAL')],
  ['Final warnings create an escalation worklist', runtime.includes('Letzte Warnung versendet · Sperrung prüfen')],
