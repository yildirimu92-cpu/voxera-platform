...
for(const token of ['openTwilioNumberAssignment','nummer eintragen','data-assign'])if(!source.runtime.toLowerCase().includes(token.toLowerCase()))failures.push('Runtime missing: '+token);
