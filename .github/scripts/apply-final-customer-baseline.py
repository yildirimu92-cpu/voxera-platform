...
p0p = "scripts/verify-p0-security-foundation.mjs"
...
assert dashboard.count(old) == 1
dashboard = dashboard.replace(old, "if (filter === 'archiv') return 'Archiv ist leer.'", 1)
...
for old, new in [
    ("/shared/customer-design-system.css?v=20260804-1", "/shared/customer-design-system.css?v=20260805-1"),
