...
exports.handler = async (event) => {
  ...
  const personName    = customer.ai_person_name   || ''; // Einzelperson/Berater Name
  ...
  // Gender-aware Assistenz-Rolle — Default weiblich (Lara)
  const assistantRole = 'die Assistentin';
