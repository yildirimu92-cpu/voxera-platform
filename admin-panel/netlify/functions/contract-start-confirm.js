...
function normalizeActivationError(err) {
  ...
  const errorMessage = orchestrationFailure && dbMessage
    ? `${baseMessage}: ${dbMessage}`
    : baseMessage;
...
exports.handler = async (event) => {
  ...
  try {
    ...
    console.error('[contract-start-confirm] activation failed', JSON.stringify({
      contract_id: contractId,
      customer_id: body.customer_id || null,
      step_failed: normalized.step_failed,
