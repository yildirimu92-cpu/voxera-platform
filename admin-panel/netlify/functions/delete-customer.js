...
exports.handler = async (event) => {
  ...
  try {
    ...
    // ──────────────────────────────────────────────
    // 7. Auth User löschen — ganz am Schluss
    //    Dein Zugriffsschutz (auth + users + customers + status)
    //    verhindert Login auch ohne diesen Schritt.
    //    Aber: Auth User muss weg, damit kein Passwort-Reset möglich ist.
    // ──────────────────────────────────────────────
    if (userRow) {
      ...
      console.log(`[delete-customer] Auth User ${userRow.id} gelöscht`);
