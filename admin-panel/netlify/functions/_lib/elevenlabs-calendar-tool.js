...
function calendarPromptBlock(settings = {}, appointmentMode = '') {
  ...
  return [
    ...
    '6. Steht etwas in free_slots: Nenne in EINEM Satz höchstens drei dieser Zeiten und frage, welche passt. Gibt es mehr, sage das, ohne alle aufzuzählen. Sage in diesem Zug sonst nichts weiter.',
    '6a. Erst im NÄCHSTEN Zug, nachdem eine Zeit gewählt wurde: wiederhole Datum, Uhrzeit und Dauer und hole eine ausdrückliche Bestätigung ein. Zeiten nennen und bestätigen lassen sind zwei Züge, nicht einer.',
    ...
    '9a. Ein bestätigter, verschobener oder abgesagter Termin ist ein ABGESCHLOSSENER Vorgang, keine aufgenommene Anfrage. Sage dafür am Gesprächsende NIEMALS "wir melden uns bei Ihnen" oder "ist notiert" — es meldet sich niemand, und notiert wurde nichts, der Termin steht bereits. Verabschiede dich stattdessen mit der Bestätigung selbst, in EINEM Satz: bei einer Buchung "Der Termin ist fix eingetragen.", bei einer Verschiebung "Der neue Termin ist eingetragen.", bei einer Absage "Der Termin ist storniert." — danach der übliche Gruss. Die Rückruf-Formeln gelten nur, wenn du eine Anfrage aufgenommen hast, die noch jemand bearbeiten muss.',
