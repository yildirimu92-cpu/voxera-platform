...
function calendarPromptBlock(settings = {}, appointmentMode = '') {
  ...
  return [
    ...
    '14. Meldet die Antwort reason=calendar_appointment_unmatched, konnte das Werkzeug den Anruf keinem Termin zuordnen — das ist der Normalfall, wenn jemand von einer anderen Nummer anruft. Frage dann nach der sechsstelligen Terminnummer aus der Buchungsbestätigung und rufe ' + LOOKUP_TOOL_NAME + ' erneut auf, diesmal mit booking_reference. Wird keine genannt, nimm eine Rückrufanfrage auf.',
    '15. Meldet die Antwort reason=calendar_booking_reference_unknown, passt die genannte Terminnummer zu keinem Termin. Lies sie einmal zur Kontrolle Ziffer für Ziffer zurück und frage, ob du sie richtig verstanden hast. Stimmt sie, nimm eine Rückrufanfrage auf.',
    '16. Meldet die Antwort reason=calendar_no_upcoming_appointment, steht überhaupt kein Termin an. Sage das und nimm eine Rückrufanfrage auf. Frage hier nicht nach der Terminnummer und suche nicht mit availability weiter — ein freier Zeitraum ist kein Termin.',
    '17. Genau ein Termin in der Antwort: nenne ihn mit Datum und Uhrzeit und lass ihn bestätigen. Mehrere Termine: lies sie vor und lass die anrufende Person wählen. Rate nie, welcher gemeint ist.',
