-- Decouple customer dashboard entitlement from billing/payment state.
-- Access is driven by customer lifecycle/access status only.
...
-- Re-apply policies so existing environments converge on the current entitlement function.
